...
MIN_FREQ = 10;
SAMPLE_RATE = 48000;
OAE_PATH = 'C:\Users\Admin\Documents\MATLAB\IDA_asio';
...
%         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        tone = sin(linspace(0,100/MIN_FREQ*2*pi*(1-1/l), l));
...
%         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%         % for electrostatic speakers only
%         wave_HF = ((200*wave_HF+212.7).^0.5-sqrt(212.7))/sqrt(200);
%         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        H_TT = fft(H_TT)./H_wave./H_mic;
        snr_TT = 20*log10(abs(snr_TT./H_mic));
        max_level_TT = snr_TT(round(100/MIN_FREQ)+1);
...
% 		zoom on,
		...
		semilogx(x(2:up_lim),20*log10(abs(ref_H_mic(2:up_lim)))....
            ...
            abs(ref_H_TT(round(100/MIN_FREQ)+1)))),'k:',...
            ...
            abs(H_TT(round(100/MIN_FREQ)+1)))),'k-'),
