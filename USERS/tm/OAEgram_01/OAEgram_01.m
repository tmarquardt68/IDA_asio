...
n_rpts=1;
f2 = logspace(log10(2000),log10(22627.41699796954/2),31);
f_BT = 60;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Now allow command line to overwrite any of the above.  
...
load(mfilename, 'stimuli_parameter');
