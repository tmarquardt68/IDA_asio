...
if rem(f2,20)~=0  % f1 is multiple of 20
    ...
    stem_60((result(number).modlines_2f1_f2-1)*10,20*log10(abs(H_mod_DPeven(result(number).modlines_2f1_f2,2))),'b.')
end
...
plot(f2,20*log10(abs(result(number).l_unmodCM_DPf2)),'co','MarkerEdgeColor',[.6 .6 .6])
plot(f1,20*log10(abs(result(number).l_unmodCM_DPf1)),'co','MarkerEdgeColor',[.6 1 .6])
plot(2*f1,20*log10(abs(result(number).l_unmodCM_2f1)),'co','MarkerEdgeColor',[1 .6 1])
plot(f2-f1,20*log10(abs(result(number).l_unmodCM_f2_f1)),'co','MarkerEdgeColor',[1 .6 .6])
plot(2*f1-f2,20*log10(abs(result(number).l_unmodCM_2f1_f2)),'co','MarkerEdgeColor',[.6 .6 1])
plot(2*f2-f1,20*log10(abs(result(number).l_unmodCM_2f2_f1)),'co','MarkerEdgeColor',[1 1 .6])
...
plot(f2,20*log10(abs(result(number).l_unmodCM_f2)),'co','MarkerEdgeColor',[.6 .6 .6])
grid on,zoom on,axis([1 2.05*f2 -30 60]),set(gca,'FontSize',7),set(gca,'Color',[.8 .8 .8])
...
figure(get_figure_h([scrsz(1)+round(scrsz(3)/6),scrsz(2)+round(scrsz(4)*3/4)-18,round(scrsz(3)/6),...
    round(scrsz(4)/4-40)]));clf
set(gcf,'Name',['Acoust DPspectrum' results.header.title ' #' num2str(number)])
...
if rem(f2,20)~=0  % f1 is multiple of 20
    ...
    stem_60((result(number).modlines_2f1_f2-1)*10,20*log10(abs(H_mod_DPeven(result(number).modlines_2f1_f2,1))),'b.')
end
...
stem_60((result(number).modlines_2f1-1)*10,20*log10(abs(H_mod_DPeven(result(number).modlines_2f1,1))),'m.')
...
plot(f2,20*log10(abs(result(number).l_unmod_SF_DPf2)),'co','MarkerEdgeColor',[.6 .6 .6])
plot(f1,20*log10(abs(result(number).l_unmod_SF_DPf1)),'co','MarkerEdgeColor',[.6 1 .6])
...
figure(get_figure_h([scrsz(1)+round(scrsz(3)/6*2),scrsz(2)+round(scrsz(4)*3/4)-18,round(scrsz(3)/6),...
    round(scrsz(4)/4-40)]));clf
set(gcf,'Name',['Acoust SFspectum' results.header.title ' #' num2str(number)])
...
plot(f2,20*log10(abs(result(number).l_unmod_SF_f2)),'co','MarkerEdgeColor',[.6 .6 .6])
grid on,zoom on,axis([1 2.05*f2 -30 110]),set(gca,'FontSize',7),set(gca,'Color',[.8 .8 .8])
