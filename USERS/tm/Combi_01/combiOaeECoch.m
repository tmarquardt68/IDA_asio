...
phase_dev_BT = angle(CURRENT_EAR(f_BT/10+1,1));
Hdb_1 = 20*log10(abs(CURRENT_EAR(f1/10+1,1)'));
Hdb_2 = 20*log10(abs(CURRENT_EAR(f2/10+1,2)'));
Hdb_suppr1 = 20*log10(abs(CURRENT_EAR(f_suppr1/10+1,2)'));
Hdb_suppr2 = 20*log10(abs(CURRENT_EAR(f_suppr2/10+1,1)'));
Hdb_BT = 20*log10(abs(CURRENT_EAR(f_BT/10+1,1)'));
