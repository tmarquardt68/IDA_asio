...
% end
try
    load('C:\Users\Admin\Documents\MATLAB\OAE_gerbil\DP_TT\_last_probe_check','CURRENT_EAR'),
    setappdata(h_fig, 'CURRENT_EAR',CURRENT_EAR),
catch
...
if ~(get(findobj(h_fig,'Tag','checkbox_frozen'),'Value') & ...
        stimulus.waveform), % not if frozen and up-to-date waveform available
