...
% Plot modDP level
h_ax(a)=subplot('position',[0.0446    0.7700    0.9429    0.21]); cla, a=a+1;
...
% Plot modDP CM
h_ax(a)=subplot('position',[0.0446    0.5100    0.9429    0.21]); cla, a=a+1;
...
% Plot modSF level
h_ax(a)=subplot('position',[0.0446    0.27    0.9429    0.200]); cla, a=a+1;
...
% Plot modCM_f2 level
h_ax(a)=subplot('position',[0.0446   0.03   0.9429    0.200]); cla
