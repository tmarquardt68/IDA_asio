...
switch action
    ...
    case 'retry'
        ...
        CURRENT_EAR(:,6) = [H_TT(1:round(200/MIN_FREQ));...
                H_rec1(round(200/MIN_FREQ)+1:l)];
        CURRENT_EAR(:,4) = H_mic;
...
% 		CURRENT_EAR(:,3)= fft(CURRENT_EAR(:,3))./H_wave_LF./H_mic;
		...
		semilogx(...
			x(10/MIN_FREQ+1:l/2),...
			20*log10(abs(CURRENT_EAR(10/MIN_FREQ+1:l...
			/2,1)./H_rec1(10/MIN_FREQ+1:l/2))),'b',...
			x(10/MIN_FREQ+1:l/2),...
            20*log10(abs(CURRENT_EAR(10/MIN_FREQ+1:l...
            /2,2)./H_rec2(10/MIN_FREQ+1:l/2))),'r',...
