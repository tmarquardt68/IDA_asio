...
%
% TO DO:
% - Play(): Refresh waveform first before playing if paramater changed
% ("dirty_flag"? see refresh). Avoid refreshing of wavefrom if no paramter 
% have changed and call Refresh_waveform after playing.
vers = '5.0';
...
old_value=str2double(get(parameter,'String'));
